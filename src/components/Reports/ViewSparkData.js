...
import {
  ...
  InputLabel, FormControl, TableContainer, Table, TableHead, TableRow, TableCell,
  TableBody, TablePagination, Card, CardContent, Dialog, DialogTitle, DialogContent,
  DialogActions
} from '@mui/material';
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={8}>
          <Paper sx={{ padding: 3, bgcolor: '#2c2c2c' }}>
            <Grid container spacing={2}>
              <Grid item xs={6} md={3}>
                <FormControl fullWidth sx={{ bgcolor: '#333', borderRadius: 1 }}>
            ...
            <TableContainer component={Paper} sx={{ marginTop: 2, bgcolor: '#333' }}>
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>X/O & T/O</TableCell>
                    <TableCell>All data</TableCell>
                    <TableCell>Wire condition</TableCell>
                    <TableCell>Insulator</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  <TableRow>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ bgcolor: '#333', color: '#00E5FF' }}>
            <CardContent>
              ...
              <Typography variant="body1">Taken At: YYYY-MM-DD-HH:MM:SS</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
